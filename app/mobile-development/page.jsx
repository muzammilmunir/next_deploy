...
const page2 = ({title,description}) => {
    ...
    //     script.src = '/scripts/script-static-page-2.js';
    //     script.async = true;
  ...
  return (
      ...
      <Script src='/scripts/script-static-page-2.js' strategy='lazyOnload'></Script>
      {/* <!-- HERO SECTION --> */}
            ...
            <div className="grid grid-cols-3">
                ...
                <div className="border-r border-[#BDBDBD]">
                    <div className="px-6 py-20 border-b border-[#BDBDBD]">
                        <div className="p-9">
                            <p className="text-[#5B5B5B] text-3xl font-bold">Android Development</p>
                    ...
                    <div className="px-6 py-20">
                        <div className="p-9">
                            <p className="text-[#5B5B5B] text-3xl font-bold">Cross-Platform Development</p>
