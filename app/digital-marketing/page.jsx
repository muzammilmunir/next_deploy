...
import '@styles/style-static-page-5.css';
import Script from 'next/script';
import Link from 'next/link';


export const metadata = {
    title: "Digital Marketing - Expobird",
    description: "nextJs demo Application"
}

const page5 = ({title, description}) =>{
    return (
        <>
          <Head>
                <title>{title}</title>
            ...
            <Script src='/scripts/script-static-page-5.js' strategy='lazyOnload'></Script>
            

            <div className="hero-gradient px-48 py-48 pb-64 rounded-b-[80px]">
        <div className="bg-[#30346f6e] max-w-[1230px] mx-auto py-[52px] rounded-[28px] backdrop-blur-md border border-[#c2c3ff]">
            <p className="text-[24px] text-white font-medium mb-12 lowercase text-center">DIGITAL MARKETING THAT DRIVES REVENUE</p>
            <p className="text-[80px] text-white font-black max-w-[1000px] text-center mx-auto leading-none my-[50px]">Capture More Revenue From Search</p>
            ...
            <div className="text-center">
                <button className="text-[#171B47] text-base bg-[#FF9E44] rounded-[70px] py-4 px-9">Contact Us <span><Image src="/assets/images/arrow-black.png" className="inline" height={12} width={12} alt="" /></span></button>
            </div>
        </div>
    </div>

    <div className="py-40">
        <p className="max-w-[1200px] text-[60px] font-black text-[#171A46] leading-none mx-auto">A <span className="gradient-text">trusted partner</span>  with the industry's highest customer satisfaction rate.</p>
        <div className="flex flex-wrap items-center mt-24 justify-evenly">
            <Image src="/assets/images/partner01.png" height={58} width={172} alt="" />
            <Image src="/assets/images/partner02.png" height={88} width={119} alt="" />
            <Image src="/assets/images/partner03.png" width={179} height={69} alt="" />
            <Image src="/assets/images/partner04.png" height={49} width={168} alt="" />
            <Image src="/assets/images/partner05.png" height={56} width={258} alt="" />
            <Image src="/assets/images/partner06.png" height={58} width={188} alt="" />
        </div>
    </div>
        ...
        <div className="px-48">
            <div className="grid grid-cols-3">
                <div className="border-r border-[#BDBDBD]">
                    <p className="text-[#171A46] text-6xl font-black mt-32">Web <br/> Development <br/> services</p>
                    ...
                    <button className="bg-[#BA83E1] rounded-[58px] py-4 px-6 text-white text-base font-medium">inhouse Technology <span><Image src="/assets/images/arrow-black.png" className="inline invert brightness-0" height={12} width={12} alt="" /></span></button>
                </div>
                <div className="border-r border-[#BDBDBD]">
                    <div className="px-6 py-20 border-b border-[#BDBDBD]">
                        <div className="p-9">
                            <p className="text-[#5B5B5B] text-3xl font-bold">WordPress Website <br/> Development</p>
                            <p className="text- text-[#878787] text-2xl my-5">You surely have a remarkable idea for Android solution</p>
                            <button className="p-6 border border-[#ADADAD] rounded-[16px]"><span><Image src="/assets/images/arrow-black.png" className="scale-75" height={12} width={12} alt="" /></span></button>
                            <Image src="/assets/images/service-animation-01.png" height={237} width={300} alt="" />
                        </div>
                    </div>
                    <div className="px-6 py-20 border-b border-[#BDBDBD]">
                        <div className="p-9">
                            <p className="text-[#5B5B5B] text-3xl font-bold">Website Maintenance</p>
                            <p className="text- text-[#878787] text-2xl my-5">Want to reach a wide audience?
                                We get that and we will gladly help.</p>
                            <button className="p-6 border border-[#ADADAD] rounded-[16px]"><span><Image src="/assets/images/arrow-black.png" height={12} width={12} className="scale-75" alt="" /></span></button>
                            <Image src="/assets/images/service-animation-03.png" height={168} width={240} className="mt-11" alt="" />
                        </div>
                    </div>
                    <div className="px-6 py-20">
                        <div className="p-9">
                            <p className="text-[#5B5B5B] text-3xl font-bold">Rapid Web Design</p>
                            <p className="text- text-[#878787] text-2xl my-5">Choose Expobird as your digital marketing agency</p>
                            <button className="p-6 border border-[#ADADAD] rounded-[16px]"><span><Image src="/assets/images/arrow-black.png" height={12} width={12} className="scale-75" alt="" /></span></button>
                            <Image src="/assets/images/service-animation-05.png" height={128} width={194} className="mt-11" alt="" />
                        </div>
                    </div>
                ...
                <div>
                    <div className="px-6 py-20 border-b border-[#BDBDBD]">
                        <div className="p-9">
                            <p className="text-[#5B5B5B] text-3xl font-bold">Custom Web <br/> Development</p>
                            <p className="text- text-[#878787] text-2xl my-5">This means that if you aim to enter the world of Apple apps</p>
                            <button className="p-6 border border-[#ADADAD] rounded-[16px]"><span><Image src="/assets/images/arrow-black.png" className="scale-75" height={12} width={12} alt="" /></span></button>
                            <Image src="/assets/images/service-animation-02.png" height={237} width={376} alt="" />
                        </div>
                    </div>
                    <div className="px-6 py-20 border-b border-[#BDBDBD]">
                        <div className="p-9">
                            <p className="text-[#5B5B5B] text-3xl font-bold">Landing Pages <br/> Development</p>
                            <p className="text- text-[#878787] text-2xl my-5">Crafting engaging and flawless custom mobile apps is in our blood.</p>
                            <button className="p-6 border border-[#ADADAD] rounded-[16px]"><span><Image src="/assets/images/arrow-black.png" className="scale-75" height={12} width={12} alt="" /></span></button>
                            <Image src="/assets/images/service-animation-04.png" className="mt-11" height={168} width={274} alt="" />
                        </div>
                    </div>
                    <div className="px-6 py-20">
                        <div className="p-9">
                            <p className="text-[#5B5B5B] text-3xl font-bold">Responsive Website <br/>Design Services</p>
                            <p className="text- text-[#878787] text-2xl my-5">Choose Expobird as your digital marketing agency</p>
                            <button className="p-6 border border-[#ADADAD] rounded-[16px]"><span><Image src="/assets/images/arrow-black.png" className="scale-75" height={12} width={12} alt="" /></span></button>
                            <Image src="/assets/images/service-animation-06.png" height={128} width={353} className="mt-11" alt="" />
                        </div>
                    </div>
    ...
    <div className="hero-gradient p-48">
        <div className="grid grid-cols-12 gap-x-36">
            <div className="col-span-6">
                <p className="text-white text-[80px] font-black mb-[50px] leading-none">Our Web Development</p>
                <p className="text-white text-[24px]">If you’re looking for serious business growth, SEO, or search engine optimization, is the strategy for you.</p>
                <p className="text-white text-[24px] my-[20px]">What is SEO? SEO is a digital marketing strategy that helps your website appear in relevant search results in search engines like Google, bringing more qualified traffic to your website. It involves various techniques, from using keywords on your pages to earning links to your site.</p>
                <p className="text-white text-[24px]">A custom SEO campaign from WebFX provides an all-in-one solution to SEO (on-page SEO, off-page SEO, and technical SEO), so your most valuable audience finds you online without you investing hours of work.</p>
            </div>
            <div className="col-span-6">
                <Image src="/assets/images/why-seo.png" height={588} width={720} alt="" />
            </div>
        </div>
    </div>
    ...
    <div className="numbers-gradient">
        <div className="px-48 pt-48">
            ...
            <div className="text-center mb-[120px]"><button className="text-white bg-[#5D6BD9] rounded-[60px] px-[24px] py-[18px]">inhouse Technology <span> <Image src="/assets/images/arrow-black.png" className="invert brightness-0 inline"  height={12} width={12} alt="" /></span></button></div>
        </div>
    ...
    <div className="technology-gradient py-48">
        <div className="grid grid-cols-2 items-center gap-x-24 px-48">
            <div>
                <p className="text-[80px] text-[#171A46] font-black leading-none">How to choose best <br /> SEO management company</p>
                <p className="text-2xl text-[#878787] mt-11 max-w-[600px]">Mobile user experience is believed to have an abundance of usability issues that potentially cause an increase in uninstall rate. Employing user-centered design, we overpower challenges, offering users optimal usability and accessibility.</p>
            </div>
            <div>
                <Image src="/assets/images/benefits2.png" height={722} width={355} className="mx-auto" alt="" />
            </div>
        </div>
        <div className="mt-48">
            <div className="grid px-48 grid-cols-12">
                <div className="sticky h-fit z-50 top-0 col-span-6">
                    <Image src="/assets/images/benefits2.png" height={722} width={355} alt="" />
                </div>
                <div className="col-span-6">
                    <div>
                        <p className="text-[80px] text-white font-black leading-none">They’re <br /> transparent</p>
                    ...
                    <div className="my-[260px]">
                        <p className="text-[80px] text-white font-black leading-none">They have over <br /> 100 testimonials</p>
                    ...
                    <div>
                        <p className="text-[80px] text-white font-black leading-none">They have an <br /> extensive trophy cabinet</p>
              ...
              <section role="feed" className="cards-horizontal">
                ...
                <article className="sample-card-horizontal numbers-gradient flex">
                    <div className="bg-[#0a0b1791] h-[750px] self-center w-[1240px] border-2 border-[#453BB1] rounded-[30px]">
                        <div className="flex justify-center items-center h-full">
                            <div>
                                <Image src="/assets/images/handshake.png" className="mb-[60px]" height={158} width={184} alt="" />
                                <div className="flex">
                                    <p className="text-[#ffffff3d] font-bold text-[60px]">01</p>
                                    <p className="font-black text-[60px] text-white leading-none mr-[60px] ml-[20px]">Understanding <br /> User Needs</p>
                                    <p className="text-[24px] text-white max-w-[420px]">We are a team of design and research experts with over ten years of experience in improving businesses and peoples’ lives through smart design solutions</p>
    ...
    <div className="p-48">
        ...
        <div className="flex gap-x-[20px] justify-center mt-[50px] mb-[100px]">
            <div className="w-[70px] h-[70px] rounded-full bg-[#5D6BD9] flex justify-center items-center">
                <Image src="/assets/images/arrow-purple.png" height={24} width={34} className="invert brightness-0 rotate-180" alt="" />
            </div>
            <div className="w-[70px] h-[70px] rounded-full bg-[#211C58] flex justify-center items-center">
                <Image src="/assets/images/arrow-purple.png" height={24} width={34} className="invert brightness-0" alt="" />
            </div>
        </div>
    ...
    <div className="bg-[#0A0B17] py-48 overflow-hidden">
        ...
        <div className="relative translate-x-2/4">
            <div className="flex">
                ...
                <Image src="/assets/images/director.png" height={823} width={433} className="saturate-0 scale-75 contrast-100" alt="" />
                <Image src="/assets/images/director.png" height={823} width={433} className="saturate-0 scale-50 contrast-100" alt="" />
    ...
    <div className="numbers-gradient p-48">
        ...
        <div className="accordion">
          <div className="accordion-item border-b-2 border-white relative">
            <button id="accordion-button-1" className="relative block text-left w-full text-[#a9b2f863] text-[46px]	py-5 " aria-expanded="true"><span className="accordion-title text-[40px] font-semibold leading-none  ">Can Shopify integrate with other platforms and services?</span><span className="icon2" aria-hidden="true">1</span><span className="icon" aria-hidden="true"><Image src="/assets/images/arrow-purple.png" height={24} width={34} className="inline" alt="" /></span></button>
          ...
          <div className="accordion-item border-b-2 border-white">
            <button id="accordion-button-2" className="relative block text-left w-full text-[#a9b2f863] text-[46px]	py-5 " aria-expanded="false"><span className="accordion-title text-[40px] font-semibold leading-none">Does Shopify support multiple languages and currencies?</span><span className="icon2" aria-hidden="true">2</span><span className="icon" aria-hidden="true"><Image src="/assets/images/arrow-purple.png" height={24} width={34} className="inline" alt="" /></span></button>
            <div className="accordion-content">
          ...
          <div className="accordion-item border-b-2 border-white">
            <button id="accordion-button-3" className="relative block text-left w-full text-[#a9b2f863] text-[46px]	py-5 " aria-expanded="false"><span className="accordion-title text-[40px] font-semibold leading-none">Can Shopify integrate with other platforms and services?</span><span className="icon2" aria-hidden="true">3</span><span className="icon" aria-hidden="true"><Image src="/assets/images/arrow-purple.png" height={24} width={34} className="inline" alt="" /></span></button>
            <div className="accordion-content">
              <p className="text-[24px] text-white mb-10">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Elementum sagittis vitae et leo duis ut. Ut tortor pretium viverra suspendisse potenti.</p>
            </div>
          </div>
          <div className="accordion-item border-b-2 border-white">
            <button id="accordion-button-4" className="relative block text-left w-full text-[#a9b2f863] text-[46px]	py-5 " aria-expanded="false"><span className="accordion-title text-[40px] font-semibold leading-none">Is Shopify suitable for small businesses?</span><span className="icon2" aria-hidden="true">4</span><span className="icon" aria-hidden="true"><Image src="/assets/images/arrow-purple.png" className="inline" height={24} width={34} alt="" /></span></button>
            <div className="accordion-content">
              <p className="text-[24px] text-white mb-10">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Elementum sagittis vitae et leo duis ut. Ut tortor pretium viverra suspendisse potenti.</p>
            </div>
          </div>
    ...
    <div className="divide-x-2 grid grid-cols-9 divide-white relative items-start overflow-x-hidden">
        ...
        <button className="block col-start-7 col-end-9 mx-[50px] py-[22px] font-medium text-center border-none bg-[#FF9E44] rounded-[117px] relative z-[10] -top-[200px] text-white text-[24px]">Get A proposal <span><Image src="/assets/images/arrow-black.png" className="inline invert brightness-0 scale-110 ml-4" height={12} width={12} alt="" /></span></button>
    </div>
