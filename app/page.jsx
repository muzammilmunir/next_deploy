    ...
    <>
      ...
      <div className="hero-gradient px-48 rounded-b-[80px] mb-24">
        <div className="flex items-center pt-20">
          <div>
            <p className="text-2xl text-white font-medium mb-12">
              digital marketing that brings revenue
            </p>
            <p className="text-7xl text-white font-black max-w-[750px]">
              Data-Driven Revenue Marketing
            </p>
            <p className="text-white text-2xl max-w-[820px] my-12">
            ...
            <form>
              <label className="block ">
                <input
                  ...
                  className="rounded-[40px] bg-transparent outline-[#5D6BD9] outline outline-1 border-none py-4 px-9 min-w-[420px] placeholder:text-white text-base text-white mr-8"
                />
        ...
        <div className="flex items-center py-48 justify-between">
          <Image
            src="/assets/images/partner01.png"
            width={172}
            height={58}
            alt=""
          />
          <Image
            src="/assets/images/partner02.png"
            width={119}
            height={88}
            alt=""
          />
          <Image
            src="/assets/images/partner03.png"
            width={179}
            height={69}
            alt=""
          />
          <Image
            src="/assets/images/partner04.png"
            width={168}
            height={49}
            alt=""
          />
          <Image
            src="/assets/images/partner05.png"
            width={258}
            height={56}
            alt=""
          />
          <Image
            src="/assets/images/partner06.png"
            width={188}
            height={58}
            alt=""
          />
        ...
        <div className="relative w-full mt-16 mb-24">
          <div className="absolute bg-[#FECE32] rounded-[64px] inset-x-0 h-[740px] cardStack-1">
            <div className="flex items-center pt-16 px-32 justify-between">
              <div>
                <p className="text-7xl text-white font-black max-w-[460px]">
                  In House Technology
                </p>
                <p className="text-2xl text-white font-normal max-w-[530px] my-11">
                  Choose Expobird as your digital marketing agency and propel
                  your business to new heights with our award-winning digital
        ...
        <div className="px-48">
          <div className="grid grid-cols-3">
            <div className="border-r border-[#BDBDBD]">
              ...
              <p className="text-2xl text-[#878787] my-12">
                Choose Expobird as your digital marketing agency and propel your
                business to new heights with our award-winning digital marketing
                services and proprietary technology platform.
              </p>
            ...
            <div className="border-r border-[#BDBDBD]">
              ...
              <div className="px-6 py-20">
                <div className="p-9">
                  ...
                  <Image
                    src="/assets/images/service-animation-07.png"
                    width={137}
                    height={150}
                    className="mt-11"
                    alt=""
            ...
            <div>
              ...
              <div className="px-6 py-20">
                <div className="p-9">
                  ...
                  <Image
                    src="/assets/images/service-animation-08.png"
                    width={129}
                    height={133}
                    className="mt-11"
                    // style={{ height: "150px" }}
      ...
      <div  >
        <div className="grid grid-cols-2 items-center gap-x-24 px-48">
          <div>
            ...
            <p className="text-2xl text-[#878787] mt-11">
              Choose Expobird as your digital marketing agency and propel your
              business to new heights with our award-winning digital marketing
              services and proprietary technology platform.
            </p>
        ...
        <div className="technology-gradient pt-96">
          ...
          <div className="max-w-[1200px] mx-auto mt-28">
            ...
            <p className="text-2xl text-white text-center pt-12">
              Choose Expobird as your digital marketing agency and propel your
              business to new heights with our award-winning digital marketing
              services and proprietary technology platform.
            </p>
            <form className="py-24 text-center">
              <label className="block">
                <input
                  ...
                  className="rounded-[40px] bg-transparent outline-white outline outline-1 border-none py-4 px-9 min-w-[840px] placeholder:text-white text-base text-white mr-8"
                />
                <button className="text-white text-base bg-[#FF9E44] rounded-[70px] py-4 px-9">
                  Get A proposal{" "}
                  <span>
                    <Image
                      src="/assets/images/arrow-black.png"
      ...
      <div className="numbers-gradient">
        <div className="px-48 pt-48">
          ...
          <p className="text-[24px] text-white text-center py-[50px]">
            Choose Expobird as your digital marketing agency and propel your
            business to new heights with our award-winning digital marketing
            services and proprietary technology platform.
          </p>
          <div className="text-center mb-[120px]">
            <button className="text-white bg-[#5D6BD9] rounded-[60px] px-[24px] py-[18px]">
              inhouse Technology{" "}
              <span>
                <Image
                  src="/assets/images/arrow-black.png"
      ...
      <div className="divOfList col-span-1 bg-white px-[27px] py-[45px] rounded-[30px]">
        <div className="list">
          <div className="list-items item-1 flex items-center gap-[32px] bg-white text-[34px] text-[#5D6BD9] font-black rounded-[45px] mb-[30px] py-[18px] px-[40px] border border-[#606367] leading-none ">
            <a href="#" className="rad-spinner rad-spinner-1">
              <span className="dial-1"><span className="dial-inner"></span></span>
              <span className="dial-2"><span className="dial-inner"></span></span>
            </a>
          <p>Amazon</p>
          </div>
          <div className="list-items item-2 flex items-center gap-[32px] bg-white text-[34px] text-[#5D6BD9] font-black rounded-[45px] mb-[30px] py-[18px] pl-[40px] pr-[20px] border border-[#606367] leading-none">
            <a href="#" className="rad-spinner rad-spinner-1">
              <span className="dial-1"><span className="dial-inner"></span></span>
              <span className="dial-2"><span className="dial-inner"></span></span>
            </a>
        <p>Social Media
          ...
          <div className="list-items item-3 flex items-center gap-[32px] bg-white text-[34px] text-[#5D6BD9] font-black rounded-[45px] mb-[30px] py-[18px] pl-[40px] pr-[20px] border border-[#606367] leading-none">
            <a href="#" className="rad-spinner rad-spinner-1">
              <span className="dial-1"><span className="dial-inner"></span></span>
              <span className="dial-2"><span className="dial-inner"></span></span>
            </a>
        <p>Performance
          ...
          <div className="list-items item-4 flex items-center gap-[32px] bg-white text-[34px] text-[#5D6BD9] font-black rounded-[45px] mb-[30px] py-[18px] px-[40px] border border-[#606367] leading-none">
            <a href="#" className="rad-spinner rad-spinner-1">
              <span className="dial-1"><span className="dial-inner"></span></span>
              <span className="dial-2"><span className="dial-inner"></span></span>
            </a>
      ...
      <div className="divOfContent col-span-2 bg-white py-[100px] rounded-[30px]">
        <div className=" auto-sections auto-section-1">
        ...
        <div className=" auto-sections auto-section-2">
          <p className="text-[240px] text-[#5D6BD9] font-black text-center leading-none mb-[35px]">300K+</p>
          <p className="text-[#5D6BD9] text-[40px] font-black text-center">World Wide</p>
        </div>
        <div className=" auto-sections auto-section-3">
          <p className="text-[240px] text-[#5D6BD9] font-black text-center leading-none mb-[35px]">400K+</p>
          <p className="text-[#5D6BD9] text-[40px] font-black text-center">World Wide</p>
        </div>
        <div className=" auto-sections auto-section-4">
          <p className="text-[240px] text-[#5D6BD9] font-black text-center leading-none mb-[35px]">500K+</p>
          <p className="text-[#5D6BD9] text-[40px] font-black text-center">World Wide</p>
        </div>
      </div>
            </div>
        ...
        <button className="block col-start-7 col-end-9 mx-[50px] py-[22px] font-medium text-center border-none bg-[#FF9E44] rounded-[117px] relative z-[10] -top-[200px] text-white text-[24px]">
          ...
          <span>
            <Image
              ...
              width={12}
              height={12}
              className="inline invert brightness-0 scale-110 ml-4"
              alt=""
            />
          </span>
        </button>
